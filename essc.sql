...
INSERT INTO `mango_attend` VALUES (11, 24, 25);
...
CREATE TABLE `mango_comment`  (
  ...
  `user_id` int(11) NOT NULL,
  `message_id` int(11) NOT NULL,
  `comment_detail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `comment_creat_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
...
INSERT INTO `mango_comment` VALUES (30, 24, 25, '规划局规划局国际化', '2023-12-02 15:51:34');
...
CREATE TABLE `mango_comment_reply`  (
  ...
  `replay_user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `receive_user_id` int(11) NOT NULL,
  `receive_user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reply_detail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reply_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
...
CREATE TABLE `mango_message`  (
  ...
  `user_major` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `message_detail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `message_share` int(11) NOT NULL DEFAULT 0,
  `message_comment` int(11) NOT NULL DEFAULT 0,
  `message_watch` int(11) NOT NULL DEFAULT 0,
  `message_creat_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
...
-- ----------------------------
INSERT INTO `mango_message` VALUES (4, 1, 21, 1, '11111111111', '222222222', '22', '11111111111111111111', 0, 1, 13, '2019-08-16 13:31:57');
...
INSERT INTO `mango_message` VALUES (13, 0, 21, 1, '15991682454', '软将从撒打算', '18', '123122222222352163521362178312312313', 0, 0, 6, '2019-08-16 19:10:02');
...
INSERT INTO `mango_message` VALUES (25, 1, 21, 11, '15991682563', '软件工程', '18', '2.0正式发布', 0, 7, 120, '2019-08-16 22:32:44');
INSERT INTO `mango_message` VALUES (26, 0, 24, 5, '15565106932', '软件工程', '21', '嘀嘀嘀嘀嘀嘀点点滴滴都是', 1, 0, 5, '2023-12-02 15:51:00');
...
CREATE TABLE `mango_new_message`  (
  `new_message_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `new_message_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `new_message_type` int(11) NOT NULL,
  `message_id` int(11) NOT NULL,
  `new_message_detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `mango_new_message` VALUES ('2023-12-02 15:51:34', 27, 21, 1, 25, '规划局规划局国际化');
...
CREATE TABLE `mango_notice`  (
  ...
  `notice_detail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `mango_shop_business`  (
  ...
  `shop_goods_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `shop_goods_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `mango_shop_images`  (
  ...
  `shop_id` int(11) NOT NULL,
  `shop_images` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `mango_swiper`  (
  ...
  `swiper_image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `mango_user`  (
  ...
  `user_nickname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_is_admin` int(11) NOT NULL DEFAULT 1,
  `user_allow` int(11) NOT NULL DEFAULT 1,
  `user_creat_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
...
INSERT INTO `mango_user` VALUES (24, 'oBk_Z6frgs7PQkGRliNzsYg7NpFc', 0, 'https://thirdwx.qlogo.cn/mmopen/vi_32/Z4vmD5nicJHe3rfyP1bIQARM7dGyoeDS0L6cJzicdsNibQn7KRl0bm7RMrtoms3kMp4cmTDS0LD0YASYErjz1sPtQ/132', 'C-peng', 1, 1, '2023-12-02 15:48:07');
